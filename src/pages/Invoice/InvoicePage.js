...
import MyDocument from '../../components/InvoiceReciepment';

// ----------------------------------------------------------------------

const TABLE_HEAD = [
  { id: 'name', label: 'Nome', alignRight: false },
  { id: 'description', label: 'PR', alignRight: false },
...
export default function InvoicePage() {
  ...
  return (
    <>
                    ...
                    return (
                      <TableRow hover key={id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell align="right">
                          <IconButton size="large" color="inherit" onClick={(e) => { handleOpenMenu(e); setActualId(id) }}>
      ...
      >
        <MenuItem onClick={() => { handleShowDocument() }}>
